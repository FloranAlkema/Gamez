...
public class Cloud extends Entity {
	...
	int myX = 0, myY = 0, dX, dY; // Bijhouden van locatie in beweging en
	...
	public void moveCloud() {
		...
		if (goingRight && myX < dX) { //
			...
			goingRight = false; // Verplaatsing in X richting met lengte dX
								// vanaf spawnpunt
		...
		if (goingUp && myY < dY) { //
			...
			goingUp = false; // Verplaatsing in Y richting met hoogte dY vanaf
								// spawnpunt
