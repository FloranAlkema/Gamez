...
public abstract class Entity {
	...
	/**
	 * This method is called after a collision with the entity and should return true if it's a passable collision
	 * 
	 * @param entity
	 * @return
	 */
	...
	protected boolean move(final Scene scene, final int x, final int y) {
		...
		for (final Entity entity : scene.entities)
			if (entity != null && entity != this && bounds.intersects(entity.getBounds()))
